...
<body>
    ...
    <div class="  d-flex justify-content-center  w-75 m-auto">
        <form method="post" class="mb-5  py-5" id="formContent" >
            <div id="add">
                <label class="d-flex text-right mr-5  flex-column text-info size">الاسم</label>  
                <input type="text"  class="fadeIn second" name="nom" placeholder="الاسم"  >

            <div class="  d-flex justify-content-between mr-5">  
               <label class="ml-5 mt-3 text-info size hover" onclick="ajouter()">إضافة موضوع</label> 
                <label class="d-flex flex-column text-right  mt-3 text-info size">المواضيع</label>            
            </div>
            
            <div class="  d-flex justify-content-between mr-5 ml-5" id="ajou">  
                <input type="text"  class="fadeIn second" name="1_" placeholder="التاربخ"  >
                <input type="text"  class="fadeIn second" name="1" placeholder="الموضوع"  >
            </div>
            
            </div>

            <input type="submit" class="fadeIn fourth mt-5" value="Envoyer" onclick="actionform()">
