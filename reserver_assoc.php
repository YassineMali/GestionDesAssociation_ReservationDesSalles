...
<form method="post" class="mb-5  py-5 w-50" id="formContent" action="#">
    ...
    <label class="d-flex flex-column text-right mr-5  text-info size">تاريخ الحجز
</label>
    ...
    <label class="d-flex flex-column text-right mr-5  text-info size">وقت الحجز
</label>
        <input type="time" placeholder="Heure De Reservation" name="heure" required/>
      


    <label class="d-flex flex-column text-right mr-5  text-info size">اسم ورقم القاعة </label>
    ...
    <label class="d-flex flex-column text-right mr-5  text-info size">عدد الاشخاص </label>
        <input type="text" name="nombre" required />



    <label class="d-flex flex-column text-right mr-5  text-info size">  البهو </label>
        <select name="hall" class="text-center">
           
                    <option value='non'> بدون البهو</option>
                    <option value="oui"> مع البهو</option>
                    
           
        </select>

    <label class="d-flex flex-column text-right mr-5  text-info size mt-3">  جهاز العرض</label>        
    <?php
        if($nbr_>=2)
        {
    ...
    ?>
        <select name="proj" class="text-center">
                    ...
                    <option value='non'> بدون جهاز</option>
                    <option value="oui"> مع الجهاز</option>
    ...
    ?>        
    <label class="d-flex flex-column text-right mr-5  text-info size mt-3">فترة  اليوم </label>
