...
<form method="post" class="mb-5  py-5 w-50" id="formContent" action="#">
        ...
        <label class="d-flex flex-column text-right mr-5  text-info size"> رقم القاعة </label>
        <input type="text" name="Num" value="<?= $num ?>" placeholder="رقم القاعة"/>
      

        <label class="d-flex flex-column text-right mr-5 mt-3 text-info size"> اسم القاعة </label>
        <input type="text" name="Nom" value="<?= $nom ?>"  placeholder="اسم القاعة"/>
      
        <label class="d-flex flex-column text-right mr-5 mt-3 text-info size"> سعة القاعة </label>

        <input type="number" name="capacite" value="<?= $capacite ?>"  placeholder="سعة القاعة"/>
...
<table id="example" class="table table-striped table-bordered" style="width:100%">
        ...
        <tr >
          ...
          <td class="text-center"> سعة القاعة </td>
          <td class="text-center"> اسم القاعة </td>
          <td class="text-center">  رقم القاعة </td>
