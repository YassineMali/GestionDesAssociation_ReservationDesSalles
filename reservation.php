...
<div class="container  mt-3 ">
  ...
  <div onclick="tous()" >
        <input type="button" style="font-size: 1.2em; font-weight: bold;" value="جميع الحجوزات" class="sub" >
    ...
    <?php
      ...
      {
    ?>
    <h3 class="sub"> حجز ليوم  :<?= $date_?> </h3>
    <?php
      }
      else
      {
    ?>
     <h3  class="sub">جميع الحجوزات</h3>
     <?php
      }
    ?>
...
<table id="example" class=" table table-striped table-bordered" style="width:100%">
        ...
        <tr>
          ...
          <td class="text-center">Matin/Soir/Jour</td>
          <td class="text-center">جهاز العرض</td>
          <td class="text-center">البهو</td>
          <td class="text-center">تاريخ الحجز</td>
          <td class="text-center">عدد الأشخاص  </td>
          <td class="text-center"> رقم القاعة </td>
          <td class="text-center">نوعية القاعة </td>
...
<div class="div">
  <form method="post" action="#"  id="formContent" >
    ...
    <div  >
        <input type="submit"  value="rechercher" onclick="afficher()">
...
<h3>les Salles disponible <?=$temps?></h3>
<table id="example" class="table table-striped table-bordered"  style="width:100% ">
        <thead>
        <tr class="text-center">
